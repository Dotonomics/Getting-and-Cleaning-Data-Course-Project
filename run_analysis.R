...
activityLabels <- read.table("./coursera/UCI HAR Dataset/activity_labels.txt")
...
# Creating some vectors: subject-ID, mean and standard deviation
...
# Creating a subset from setAllInOne
setForMeanAndStd <- setAllInOne[ , mean_and_std == TRUE]

# Using acitivity names to name the activities in the data set
